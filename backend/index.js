...
//This snippet of code takes in a request body from the Todo List Application which represents a todo item. The body is then converted into a new json object called newTask to represent the new todo item. The new json object is finally appended to a json list located in a file called database.json to represent our todos list.
